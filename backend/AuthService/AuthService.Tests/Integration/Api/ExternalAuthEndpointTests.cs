...
public class ExternalAuthEndpointTests : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _client;

    public ExternalAuthEndpointTests(CustomWebApplicationFactory factory)
    {
        _client = factory.CreateClient();
    }

    [Fact]
    public async Task Authenticate_WithoutProvider_ReturnsBadRequest()
    {
        // Arrange
    ...
    [Fact]
    public async Task Authenticate_WithoutIdToken_ReturnsBadRequest()
    {
        // Arrange
    ...
    [Fact]
    public async Task Login_WithoutProvider_ReturnsBadRequest()
    {
        // Arrange
    ...
    [Fact]
    public async Task Login_WithoutRedirectUri_ReturnsBadRequest()
    {
        // Arrange
    ...
    [Fact]
    public async Task LinkAccount_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task UnlinkAccount_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetLinkedAccounts_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Act
    ...
    [Fact]
    public async Task Callback_WithoutProvider_ReturnsBadRequest()
    {
        // Arrange
