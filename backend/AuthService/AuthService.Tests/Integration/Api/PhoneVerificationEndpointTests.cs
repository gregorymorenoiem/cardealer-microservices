...
public class PhoneVerificationEndpointTests : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _client;

    public PhoneVerificationEndpointTests(CustomWebApplicationFactory factory)
    {
        _client = factory.CreateClient();
    }

    [Fact]
    public async Task SendVerification_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task ResendVerification_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetVerificationStatus_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Act
    ...
    [Fact]
    public async Task UpdatePhoneNumber_WithoutAuthentication_ReturnsUnauthorized()
    {
        // Arrange
