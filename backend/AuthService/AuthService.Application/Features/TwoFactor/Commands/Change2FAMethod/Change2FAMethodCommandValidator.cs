...
public class Change2FAMethodCommandValidator : AbstractValidator<Change2FAMethodCommand>
{
    public Change2FAMethodCommandValidator()
    {
        RuleFor(x => x.UserId)
        ...
        RuleFor(x => x.NewMethod)
            .IsInEnum().WithMessage("El nuevo método 2FA no es válido");
