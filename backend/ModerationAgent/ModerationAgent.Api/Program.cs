using ModerationAgent.Application;
using ModerationAgent.Infrastructure;
...
const string ServiceName = "ModerationAgent";
...
try
{
    ...
    // Internal service policy — only other microservices can call moderation
    builder.Services.AddAuthorizationBuilder()
        .AddPolicy("InternalService", p => p.RequireAuthenticatedUser());
