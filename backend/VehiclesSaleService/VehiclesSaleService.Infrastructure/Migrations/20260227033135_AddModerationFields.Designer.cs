...
namespace VehiclesSaleService.Infrastructure.Migrations
{
    ...
    [Migration("20260227033135_AddModerationFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VehiclesSaleService.Domain.Entities.LeadMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("lead_messages", (string)null);
                });
            ...
            modelBuilder.Entity("VehiclesSaleService.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<Guid?>("LinkedCampaignId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VehiclesSaleService.Domain.Entities.LeadMessage", b =>
                {
                    b.HasOne("VehiclesSaleService.Domain.Entities.Lead", "Lead")
                        .WithMany("Messages")
