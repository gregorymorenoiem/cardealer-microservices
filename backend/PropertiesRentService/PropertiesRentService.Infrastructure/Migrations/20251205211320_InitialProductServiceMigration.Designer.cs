...
namespace PropertiesRentService.Infrastructure.Migrations
{
    ...
    [Migration("20251205211320_InitialPropertiesRentServiceMigration")]
    partial class InitialPropertiesRentServiceMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.ProductCustomField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.Category", b =>
                {
                    b.HasOne("PropertiesRentService.Domain.Entities.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.Product", b =>
                {
                    b.HasOne("PropertiesRentService.Domain.Entities.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("PropertiesRentService.Domain.Entities.ProductCustomField", b =>
                {
                    b.HasOne("PropertiesRentService.Domain.Entities.Product", "Product")
