...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new()
    {
        Title = "PropertiesRentService API",
        Version = "v1",
        Description = "API for real estate rentals marketplace - rent apartments, houses, rooms, and commercial spaces"
    });
});
...
Console.WriteLine("🚀 PropertiesRentService API starting...");
