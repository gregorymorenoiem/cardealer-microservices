...
using RoleService.Shared.ErrorMessages;
...
namespace RoleService.Infrastructure.Services.Messaging;
...
public class RoleServiceRabbitMQSettings
{
...
public class RabbitMQErrorConsumer : BackgroundService
{
    ...
    private readonly RoleServiceRabbitMQSettings _settings;
    private readonly JsonSerializerOptions _jsonOptions;

    public RabbitMQErrorConsumer(
        IOptions<RabbitMQSettings> rabbitMqSettings,
        IOptions<RoleServiceRabbitMQSettings> RoleServiceSettings,
        IServiceProvider serviceProvider,
        ILogger<RabbitMQErrorConsumer> logger)
    {
        _serviceProvider = serviceProvider;
        _logger = logger;
        _settings = RoleServiceSettings.Value;
