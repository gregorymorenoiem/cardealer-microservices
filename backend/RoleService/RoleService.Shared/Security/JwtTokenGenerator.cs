...
namespace RoleService.Shared.Security
{
    /// <summary>
    ...
    public class JwtTokenGenerator
    {
        ...
        /// <summary>
        /// Genera un token JWT para acceso al RoleService
        /// </summary>
        public string GenerateRoleServiceToken(string? userId = null, string? serviceName = null)
        {
        ...
        /// <summary>
        /// Genera un token JWT para acceso administrativo al RoleService
        /// </summary>
