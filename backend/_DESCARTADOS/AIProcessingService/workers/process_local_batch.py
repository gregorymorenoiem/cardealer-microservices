...
class SAM2Processor:
    ...
    def _load_model(self):
        ...
        local_model_path = os.path.join(os.path.dirname(__file__), "models", "sam2_hiera_large.pt")
        docker_model_path = "/models/sam2_hiera_base_plus.pt"
        
        model_path = local_model_path if os.path.exists(local_model_path) else docker_model_path
        ...
        if os.path.exists(model_path):
            try:
                ...
                # Determine config based on model file
