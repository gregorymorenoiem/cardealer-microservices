...
public class CategoryTests
{
    ...
    [Fact]
    public void Category_ForRentals_ShouldSupportRentalTypes()
    {
        // Arrange & Act
        var categories = new List<Category>
        {
            new() { Id = Guid.NewGuid(), Name = "Apartments", Slug = "apartments" },
            new() { Id = Guid.NewGuid(), Name = "Houses", Slug = "houses" },
            new() { Id = Guid.NewGuid(), Name = "Condos", Slug = "condos" },
            new() { Id = Guid.NewGuid(), Name = "Studios", Slug = "studios" },
            new() { Id = Guid.NewGuid(), Name = "Rooms", Slug = "rooms" },
            new() { Id = Guid.NewGuid(), Name = "Short-Term", Slug = "short-term" }
        };
