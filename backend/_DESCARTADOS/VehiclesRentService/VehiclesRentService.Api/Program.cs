...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new()
    {
        Title = "VehiclesRentService API",
        Version = "v1",
        Description = "API for vehicle rentals marketplace - rent cars, trucks, motorcycles, boats, and more"
    });
});
...
Console.WriteLine("🚀 VehiclesRentService API starting...");
