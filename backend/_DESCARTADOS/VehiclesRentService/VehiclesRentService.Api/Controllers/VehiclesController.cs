...
namespace VehiclesRentService.Api.Controllers;
...
public class VehiclesController : ControllerBase
{
    ...
    /// <summary>
    /// Search vehicles for rent with filters
    /// </summary>
    [HttpGet]
    ...
    public async Task<ActionResult<Vehicle>> Create([FromBody] CreateVehicleRequest request)
    {
        ...
        _logger.LogInformation("Rental vehicle created: {VehicleId} - {Title}", created.Id, created.Title);
    ...
    public async Task<ActionResult<Vehicle>> Update(Guid id, [FromBody] UpdateVehicleRequest request)
    {
        ...
        _logger.LogInformation("Rental vehicle updated: {VehicleId}", id);
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        _logger.LogInformation("Rental vehicle deleted: {VehicleId}", id);
