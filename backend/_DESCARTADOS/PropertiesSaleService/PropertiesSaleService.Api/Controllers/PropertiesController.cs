...
public class PropertiesController : ControllerBase
{
    ...
    /// <summary>
    /// Search properties for sale with filters
    /// </summary>
    [HttpGet]
    ...
    /// <summary>
    /// Get featured properties for sale
    /// </summary>
    [HttpGet("featured")]
    ...
    /// <summary>
    /// Create new property listing for sale
    /// </summary>
    [HttpPost]
    public async Task<ActionResult<Property>> Create([FromBody] CreatePropertyRequest request)
    {
        ...
        _logger.LogInformation("Property for sale created: {PropertyId} - {Title}", created.Id, created.Title);
    ...
    public async Task<ActionResult<Property>> Update(Guid id, [FromBody] UpdatePropertyRequest request)
    {
        ...
        _logger.LogInformation("Property for sale updated: {PropertyId}", id);
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        _logger.LogInformation("Property for sale deleted: {PropertyId}", id);
