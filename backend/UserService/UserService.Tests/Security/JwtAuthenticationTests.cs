    ...
    public class JwtAuthenticationTests
    {
        ...
        public void GenerateToken_WithValidClaims_ReturnsValidJwtToken()
        {
            ...
            var claims = new[]
            {
                ...
                new Claim(ClaimTypes.Role, "UserServiceAdmin")
            };
        ...
        public void ValidateToken_WithValidToken_ReturnsClaimsPrincipal()
        {
            ...
            Assert.True(principal.HasClaim("service", "UserService"));
        }
        ...
        {
            // Arrange
            var claims = new[] { new Claim("service", "UserService") };
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_validKey));
            var credentials = new SigningCredentials(key, SecurityAlgorithms.HmacSha256);
        ...
        [Fact]
        public void Token_WithUserServiceAccessClaim_ShouldHaveServiceClaim()
        {
            // Arrange
            var claims = new[]
            {
            ...
            // Assert
            Assert.True(principal.HasClaim("service", "UserService"));
            Assert.True(principal.IsInRole("UserServiceAdmin"));
        }
        ...
        public void Token_WithMultipleRoles_ShouldContainAllRoles()
        {
            ...
            var claims = new[]
            {
                new Claim("service", "UserService"),
                new Claim(ClaimTypes.Role, "UserServiceAdmin"),
                new Claim(ClaimTypes.Role, "UserServiceRead")
            };
            ...
            // Assert
            Assert.True(principal.IsInRole("UserServiceAdmin"));
            Assert.True(principal.IsInRole("UserServiceRead"));
        }
    }
}
