...
namespace UserService.Infrastructure.Migrations
{
    ...
    public partial class AddDealerAndSellerProfile : Migration
    {
        ...
        {
            // Add columns to Users table if they don't exist (using raw SQL for IF NOT EXISTS)
            migrationBuilder.Sql(@"
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""CreatedBy"" uuid DEFAULT NULL;
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""DealerId"" uuid DEFAULT NULL;
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""DealerPermissions"" varchar(2000) DEFAULT '[]';
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""DealerRole"" integer DEFAULT 0;
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""EmployerUserId"" uuid DEFAULT NULL;
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""PlatformPermissions"" varchar(2000) DEFAULT '[]';
                ALTER TABLE ""Users"" ADD COLUMN IF NOT EXISTS ""PlatformRole"" integer DEFAULT 0;
            ");
