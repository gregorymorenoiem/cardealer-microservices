...
/// <summary>
/// RabbitMQ implementation of IEventPublisher for MediaService
...
public class RabbitMqEventPublisher : IEventPublisher, IDisposable
{
        ...
        ILogger<RabbitMqEventPublisher> logger)
    {
        ...
        try
        {
            ...
            _logger.LogInformation(
                "RabbitMQ Event Publisher initialized for MediaService. Exchange: {ExchangeName}",
                _exchangeName);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Failed to initialize RabbitMQ Event Publisher for MediaService");
            throw;
        }
    }
    ...
    public void Dispose()
    {
        ...
        {
            _logger.LogError(ex, "Error disposing RabbitMQ Event Publisher for MediaService");
        }
    }
}
