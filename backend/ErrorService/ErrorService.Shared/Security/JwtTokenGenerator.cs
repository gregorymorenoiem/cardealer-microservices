...
namespace ErrorService.Shared.Security
{
    /// <summary>
    ...
    public class JwtTokenGenerator
    {
        ...
        /// <summary>
        /// Genera un token JWT para acceso al ErrorService
        /// </summary>
        public string GenerateErrorServiceToken(string? userId = null, string? serviceName = null)
        {
        ...
        /// <summary>
        /// Genera un token JWT para acceso administrativo al ErrorService
        /// </summary>
