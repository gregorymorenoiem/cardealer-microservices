...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                      Test Drive Scheduling Architecture                      │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│   User Flow                          Core Service                            │
│   ┌────────────────┐              ┌─────────────────────────────────────┐   │
│   │ Vehicle Detail │──┐           │        AppointmentService           │   │
│   │ (Book Button)  │  │           │  ┌───────────────────────────────┐  │   │
│   └────────────────┘  │           │  │ TestDrive Controller          │  │   │
│   ┌────────────────┐  │           │  │ • GET /availability           │  │   │
│   │ Calendar       │──┼──────────▶│  │ • POST /testdrives            │  │   │
│   │ (Select Slot)  │  │           │  │ • POST /checkin /checkout     │  │   │
│   └────────────────┘  │           │  └───────────────────────────────┘  │   │
│   ┌────────────────┐  │           │  ┌───────────────────────────────┐  │   │
│   │ Waiver Form    │──┤           │  │ Business Logic                │  │   │
│   │ (E-Signature)  │  │           │  │ • Availability check          │  │   │
│   └────────────────┘  │           │  │ • Waiver generation           │  │   │
│   ┌────────────────┐  │           │  │ • Odometer tracking           │  │   │
│   │ Check-in       │──┘           │  │ • Follow-up automation        │  │   │
│   │ (At Dealer)    │              │  └───────────────────────────────┘  │   │
│   └────────────────┘              │  ┌───────────────────────────────┐  │   │
│                                   │  │ Domain                        │  │   │
│   Dealer Side                     │  │ • TestDrive (extends Appt)    │  │   │
│   ┌────────────────┐              │  │ • Waiver, DriverInfo          │  │   │
│   │ Dealer Dash    │◀────────────│  │ • VehicleCheckpoint           │  │   │
│   │ (Manage Slots) │              │  └───────────────────────────────┘  │   │
│   └────────────────┘              └─────────────────────────────────────┘   │
│                                                    │                        │
│                                    ┌───────────────┼───────────────┐        │
