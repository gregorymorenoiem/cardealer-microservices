      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-900">Así se verá tu publicación</h1>
            <p className="text-gray-600">Revisa que todo esté correcto antes de publicar</p>
          </div>
          <Link href="/publicar">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                {Array.from({ length: vehicle.photos }).map((_, i) => (
                  <button
                    ...
                    className={`h-16 w-16 flex-shrink-0 rounded-lg bg-gray-200 ${
                      i === currentImageIndex ? 'ring-2 ring-emerald-500' : ''
                    }`}
                  />
                ))}
              </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
                  <div className="rounded-lg bg-gray-50 p-3 text-center">
                    <Gauge className="mx-auto mb-1 h-5 w-5 text-gray-600" />
                    <p className="text-sm text-gray-500">Kilometraje</p>
                    <p className="font-medium">{vehicle.mileage.toLocaleString()} km</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-3 text-center">
                    <Fuel className="mx-auto mb-1 h-5 w-5 text-gray-600" />
                    <p className="text-sm text-gray-500">Combustible</p>
                    <p className="font-medium">{vehicle.fuelType}</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-3 text-center">
                    <Settings className="mx-auto mb-1 h-5 w-5 text-gray-600" />
                    <p className="text-sm text-gray-500">Transmisión</p>
                    <p className="font-medium">{vehicle.transmission}</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-3 text-center">
                    <Palette className="mx-auto mb-1 h-5 w-5 text-gray-600" />
                ...
                <div className="mb-6">
                  ...
                  <p className="whitespace-pre-line text-gray-600">{vehicle.description}</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-emerald-200 bg-emerald-50">
              <CardContent className="p-6">
                <h3 className="mb-4 font-semibold text-gray-900">Contactar Vendedor</h3>
            ...
            <Card className="border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50">
              <CardContent className="p-6">
                <div className="mb-3 flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-gray-900">Destacar Publicación</h3>
                </div>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="mb-4 font-semibold text-gray-900">Estado de Publicación</h3>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Todos los campos requeridos</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Mínimo requerido: 5</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500">Pendiente de revisión</p>
                      <p className="text-xs text-gray-500">Aproximadamente 24 horas</p>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        {/* Action Buttons */}
        <div className="mt-8 flex items-center justify-between rounded-lg border bg-white p-6 shadow-sm">
