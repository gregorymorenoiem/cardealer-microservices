      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Estadísticas del Vehículo</h1>
              ...
              <div className="mb-2 flex items-center justify-between">
                ...
                <div
                  className={`flex items-center text-xs ${
                    stats.views.trend === 'up' ? 'text-emerald-600' : 'text-red-600'
                  }`}
                >
          ...
          <Card>
            <CardContent className="p-4">
              <div className="mb-2 flex items-center justify-between">
                ...
                <div
                  className={`flex items-center text-xs ${
                    stats.calls.trend === 'up' ? 'text-emerald-600' : 'text-red-600'
                  }`}
                >
          ...
          <Card>
            <CardContent className="p-4">
              <div className="mb-2 flex items-center justify-between">
                ...
                <div
                  className={`flex items-center text-xs ${
                    stats.messages.trend === 'up' ? 'text-emerald-600' : 'text-red-600'
                  }`}
                >
          ...
          <Card>
            <CardContent className="p-4">
              <div className="mb-2 flex items-center justify-between">
                ...
                <div
                  className={`flex items-center text-xs ${
                    stats.favorites.trend === 'up' ? 'text-emerald-600' : 'text-red-600'
                  }`}
                >
                  <TrendingUp className="mr-1 h-3 w-3" />
                ...
                <div className="flex h-48 items-end justify-between gap-2">
                  {dailyViews.map(day => (
                    <div key={day.day} className="flex flex-1 flex-col items-center">
                      <span className="mb-1 text-xs text-gray-500">{day.views}</span>
                      <div
              ...
              <div className="space-y-3">
                {topLocations.map((loc, i) => (
                  <div key={loc.location} className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-500">{loc.views}</span>
                  </div>
                ))}
              </div>
            </CardContent>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{interaction.location}</p>
                      </div>
                    </div>
