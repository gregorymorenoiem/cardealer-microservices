...
export default function DealerProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Perfil del Dealer</h1>
          <p className="text-gray-600">Gestiona tu información pública</p>
        </div>
        <div className="flex gap-3">
      ...
      {/* Profile Status */}
      <Card
        className={isVerified ? 'border-emerald-200 bg-emerald-50' : 'border-amber-200 bg-amber-50'}
      >
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Shield className={`h-6 w-6 ${isVerified ? 'text-emerald-600' : 'text-amber-600'}`} />
              <div>
                <p className={`font-medium ${isVerified ? 'text-emerald-800' : 'text-amber-800'}`}>
            ...
            {dealer.rating && (
              <div className="flex items-center gap-2">
                ...
                {dealer.reviewCount && (
                  <span className="text-sm text-gray-500">({dealer.reviewCount} reseñas)</span>
                )}
              </div>
            )}
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="group relative mt-2 h-48 overflow-hidden rounded-lg bg-gray-100">
                  {dealer.bannerUrl ? (
                ...
                <div className="mt-2 flex items-center gap-4">
                  <div className="group relative h-24 w-24 overflow-hidden rounded-lg bg-gray-100">
                    {dealer.logoUrl ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-emerald-400 to-emerald-600 text-3xl font-bold text-white">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">PNG o JPG, máx 2MB</p>
                  </div>
                  <input
                    ref={logoInputRef}
                    type="file"
