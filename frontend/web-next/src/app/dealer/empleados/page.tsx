  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="mb-4 text-lg font-medium text-gray-600">Error al cargar empleados</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        <div>
          ...
          <p className="text-gray-600">Gestiona tu equipo y permisos</p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Límite Plan</p>
              </div>
            </div>
          </CardContent>
        </Card>
