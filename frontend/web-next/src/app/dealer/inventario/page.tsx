                ...
                <table className="w-full">
                  <thead className="border-b bg-gray-50">
                    <tr>
                      ...
                      <th className="p-4 text-left text-sm font-medium text-gray-600">Vehículo</th>
                      <th className="p-4 text-left text-sm font-medium text-gray-600">Precio</th>
                      <th className="p-4 text-left text-sm font-medium text-gray-600">Estado</th>
                      <th className="p-4 text-center text-sm font-medium text-gray-600">Vistas</th>
                      <th className="p-4 text-center text-sm font-medium text-gray-600">Días</th>
                    ...
                    {filteredVehicles.map(vehicle => {
                      ...
                      return (
                        <tr key={vehicle.id} className="hover:bg-gray-50">
                          ...
                          <td className="p-4 text-center">
                            <span className={daysListed > 30 ? 'text-amber-600' : 'text-gray-600'}>
                              {daysListed}
                            </span>
                          </td>
                          <td className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => i + 1).map(p => (
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className={page === p ? 'bg-emerald-50' : ''}
                      onClick={() => setPage(p)}
                    >
                      {p}
                    </Button>
