    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        <div>
          ...
          <p className="text-gray-600">Gestiona tus sucursales y puntos de venta</p>
        </div>
      ...
      <div className="space-y-4">
        {locations && locations.length > 0 ? (
          locations.map(location => {
            ...
            return (
              <Card key={location.id} className={location.isPrimary ? 'border-emerald-200' : ''}>
                <CardContent className="p-6">
                  <div className="flex flex-col gap-6 lg:flex-row">
                    {/* Map placeholder */}
                    <div className="flex h-40 items-center justify-center rounded-lg bg-gray-100 lg:h-auto lg:w-64">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 rounded-lg bg-gray-50 p-3">
                        ...
                        <div className="grid grid-cols-3 gap-2 text-sm">
                          <div>
                            <p className="text-gray-500">Lun - Vie</p>
                          ...
                          <div>
                            <p className="text-gray-500">Domingo</p>
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="mb-2 text-lg font-medium text-gray-900">No hay ubicaciones</h3>
              <p className="mb-4 text-gray-500">Agrega tu primera ubicación para comenzar</p>
              <Button className="bg-emerald-600 hover:bg-emerald-700">
                <Plus className="mr-2 h-4 w-4" />
                Agregar Ubicación
              </Button>
