...
const getStatusBadge = (status: string) => {
  switch (status) {
    ...
    case 'rejected':
      return <Badge className="bg-gray-100 text-gray-700">Rechazado</Badge>;
    default:
...
const getPlanBadge = (plan: string) => {
  switch (plan) {
    ...
    case 'starter':
      return <Badge className="bg-gray-100 text-gray-700">Starter</Badge>;
    default:
...
export default function AdminDealersPage() {
  ...
  const { data: dealersData, isLoading, refetch } = useAdminDealers(filters);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        <div>
          ...
          <p className="text-gray-600">Gestiona los dealers de la plataforma</p>
        </div>
