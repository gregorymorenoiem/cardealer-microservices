  ...
  return (
    <div className="mx-auto w-full max-w-md">
      <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/10">
        <div
          className="h-full rounded-full bg-gradient-to-r from-primary via-primary to-primary transition-all duration-100"
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-10 bottom-32 text-primary">
      ...
      <div className="relative z-10 flex max-w-2xl flex-col items-center text-center">
        ...
        <div className="mb-10">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary/80 shadow-xl shadow-primary/40">
        ...
        {/* Divider */}
        <div className="mb-8 h-px w-32 bg-gradient-to-r from-transparent via-primary/30 to-transparent" />
        ...
        <div className="space-y-3 text-sm text-primary/40/50">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-primary/20 bg-primary/5 px-4 py-2 text-primary/60 transition-colors hover:bg-primary/15 hover:text-white"
            >
              <svg
                width="16"
                height="16"
