  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        <div>
          <h1 className="text-foreground text-2xl font-bold">¡Hola, Usuario! 👋</h1>
          <p className="text-muted-foreground">Bienvenido a tu dashboard de OKLA</p>
        </div>
              ...
              <Card className="cursor-pointer transition-shadow hover:shadow-md">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`bg-muted rounded-full p-3 ${stat.color}`}>
            ...
            <div className="space-y-4">
              {recentActivity.map((activity, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="hover:bg-muted/50 flex items-center gap-4 rounded-lg p-3"
                  >
              ...
              <Link key={vehicle.id} href={`/vehiculos/${vehicle.id}`} className="group block">
                <div className="overflow-hidden rounded-lg border transition-shadow hover:shadow-md">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-muted-foreground text-xs">{vehicle.location}</p>
                  </div>
                </div>
              </Link>
            ))}
