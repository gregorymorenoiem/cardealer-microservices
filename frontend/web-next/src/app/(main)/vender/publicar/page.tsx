 ...
 *
 * IMPORTANT: This page requires KYC verification to access.
 * Users without verified identity will be redirected to /cuenta/verificacion
 */
...
import { VerificationGate } from '@/components/kyc';
            ...
            <div
              className={cn(
                ...
                formData.images.length >= 10
                  ...
                  : 'border-border cursor-pointer hover:border-[#00A870] hover:bg-[#00A870]/5'
              )}
              onClick={() => {
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-muted-foreground text-xs">
                Ingresa el precio sin separadores de miles
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={5}
                className="border-border w-full rounded-md border px-3 py-2 text-sm focus:border-[#00A870] focus:ring-1 focus:ring-[#00A870] focus:outline-none"
              />
              <p className="text-muted-foreground text-xs">
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h3 className="text-foreground font-semibold">Verificación del anuncio</h3>
              <div className="space-y-2">
                <ChecklistItem
      ...
      <div className="bg-muted/50 min-h-screen py-8">
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-foreground mt-4 text-2xl font-bold">Publicar vehículo</h1>
            <p className="text-muted-foreground">Completa los datos de tu vehículo</p>
          </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span
                        className={cn(
                          ...
                          isCurrent ? 'text-[#00A870]' : 'text-muted-foreground'
                        )}
                      >
                        {step.name}
                      </span>
                    ...
                    {index < steps.length - 1 && (
                      <div
                        className={cn(
                          ...
                          currentStep > step.id ? 'bg-[#00A870]' : 'bg-muted'
                        )}
                      />
                    )}
                  </React.Fragment>
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              ...
              <Button variant="ghost" onClick={clearDraft} className="text-muted-foreground gap-2">
