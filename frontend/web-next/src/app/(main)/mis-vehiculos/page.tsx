...
export default function MisVehiculosPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'active':
        return <Badge className="bg-primary/100">Activo</Badge>;
      case 'pending':
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Vistas Total</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <Card key={vehicle.id} className="transition-shadow hover:shadow-md">
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                  {/* Image */}
                  <div className="relative h-40 flex-shrink-0 bg-muted md:h-auto md:w-48">
