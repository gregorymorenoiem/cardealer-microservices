        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500">El email no puede ser cambiado</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={3}
                className="focus:ring-primary/20 focus:border-primary w-full resize-none rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:outline-none"
              />
              <p className="text-sm text-gray-500">{profile.bio.length}/500 caracteres</p>
            </div>
          </CardContent>
        </Card>
