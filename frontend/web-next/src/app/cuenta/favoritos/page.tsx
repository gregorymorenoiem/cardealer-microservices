...
function EmptyState() {
  return (
    <div className="py-16 text-center">
      ...
      <h3 className="mb-2 text-lg font-medium text-gray-900">No tienes favoritos</h3>
    ...
    <Card className={cn('overflow-hidden transition-opacity', isRemoving && 'opacity-50')}>
      <div className="flex flex-col sm:flex-row">
        ...
        <Link
          ...
          className="relative h-40 w-full flex-shrink-0 bg-gray-100 sm:h-auto sm:w-56"
        >
          {vehicle.imageUrl ? (
          ...
          {vehicle.priceChanged && vehicle.previousPrice && (
            <Badge className="absolute top-2 left-2 bg-emerald-500">Precio reducido</Badge>
          )}
        </Link>
        ...
        <CardContent className="flex-1 p-4">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0 flex-1">
              ...
              >
                <h3 className="truncate font-semibold text-gray-900">{vehicle.title}</h3>
              </Link>
              ...
              <div className="mt-2 flex items-center justify-between">
                <p className="text-xs text-gray-400">Guardado {timeAgo(favorite.createdAt)}</p>
