              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  {conversation.contact.isOnline && (
                    <div className="absolute right-0 bottom-0 h-3 w-3 rounded-full border-2 border-white bg-emerald-500" />
                  )}
                </div>
                <div>
              ...
              >
                ...
                <div
                  className={`mt-1 flex items-center justify-end gap-1 ${
                    message.sender === 'me' ? 'text-emerald-100' : 'text-gray-400'
                  }`}
                >
          ...
          <Card className="border-emerald-200 bg-emerald-50">
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">Cita Programada</p>
                  <p className="text-sm text-gray-600">Sábado, 10:00 AM</p>
