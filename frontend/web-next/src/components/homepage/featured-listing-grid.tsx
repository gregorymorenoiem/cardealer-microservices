        ...
        <Link href={vehicleUrl} className="group block">
          ...
          <div className="relative aspect-[4/3] overflow-hidden">
            ...
            {vehicle.condition === 'Certified Pre-Owned' && (
              <div className="absolute bottom-2 left-2 sm:bottom-3 sm:left-3">
                <span className="rounded-full bg-emerald-600 px-2 py-1 text-xs font-semibold text-white sm:px-3">
                  Certificado
                </span>
              </div>
            )}
          ...
          <div className="p-3 sm:p-4">
            ...
            <div className="mb-2 sm:mb-3">
              <h3 className="group-hover:text-primary line-clamp-1 text-base leading-snug font-bold tracking-tight text-slate-900 transition-colors sm:text-lg">
            ...
            {/* Key Details */}
            <div className="grid grid-cols-3 gap-2 text-xs text-slate-600 sm:gap-3 sm:text-sm">
              <div className="flex items-center gap-1">
                <Gauge size={14} className="flex-shrink-0 text-slate-400 sm:h-4 sm:w-4" />
                <span className="truncate font-medium">{formatMileage(vehicle.mileage)}</span>
              </div>
              <div className="flex items-center gap-1">
                <Calendar size={14} className="flex-shrink-0 text-slate-400 sm:h-4 sm:w-4" />
                <span className="font-medium">{vehicle.year}</span>
              </div>
              <div className="flex items-center gap-1">
                <MapPin size={14} className="flex-shrink-0 text-slate-400 sm:h-4 sm:w-4" />
