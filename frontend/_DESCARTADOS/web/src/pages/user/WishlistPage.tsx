...
export default function WishlistPage() {
  ...
  const [folders, setFolders] = useState<WishlistFolder[]>([
    { id: 'all', name: t('wishlist.folders.all'), vehicleIds: [] },
  ]);
    ...
    <MainLayout>
          ...
          <div className="mb-8">
              ...
              <div className="flex gap-2">
                {favorites.length > 0 && (
                  <>
                    ...
                    >
                      <FiShare2 />
                      <span className="hidden sm:inline">{t('wishlist.share.title')}</span>
                    </button>
                    <button
                    ...
                    >
                      <FiFolderPlus />
                      <span className="hidden sm:inline">{t('wishlist.folders.new')}</span>
                    </button>
                    <button
            ...
            <p className="text-gray-600">
              {favorites.length === 0 
                ...
                : t('wishlist.subtitle', { count: favorites.length })
              }
            </p>
          </div>
          ...
          {displayedVehicles.length > 0 ? (
            ...
            <div className="bg-white rounded-lg shadow-md p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">
                {activeFolder === 'all' ? t('wishlist.empty') : t('wishlist.folders.empty')}
              </h3>
              <p className="text-gray-600 mb-6">
                {activeFolder === 'all' 
                  ? t('wishlist.emptyDescription')
                  : t('wishlist.folders.emptyDescription')
                }
              </p>
              <Link
                to="/browse"
      ...
      {showNewFolderModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-gray-900">{t('wishlist.folders.create')}</h2>
              <button
            ...
            <input
              ...
              placeholder={t('wishlist.folders.namePlaceholder')}
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-gray-900">{t('wishlist.share.title')}</h2>
              <button
                ...
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({
                      ...
                      text: t('wishlist.share.description'),
                      url: shareLink,
                    });
                  }
                }}
