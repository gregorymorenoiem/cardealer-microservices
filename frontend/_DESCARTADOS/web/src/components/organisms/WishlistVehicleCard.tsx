...
import { FiTrash2, FiEdit3, FiFolder, FiX, FiCheck } from 'react-icons/fi';
          ...
          <div className="flex-1 p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 text-sm">
              <div>
                ...
                <p className="font-semibold text-lg text-primary">{formatPrice(vehicle.price)}</p>
              </div>
              <div>
              ...
              <div className="mb-4">
                ...
                >
                  <option value="" disabled>
                    {t('common:wishlist.addToFolder')}
                  </option>
                  {allFolders
                    .filter((f) => f.id !== 'all' && !f.vehicleIds.includes(vehicle.id))
                    .map((folder) => (
