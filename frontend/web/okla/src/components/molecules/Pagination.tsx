  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white rounded-xl shadow-card p-6">
      ...
      <div className="text-sm text-gray-600">
        {t('filters.showing')} <span className="font-semibold text-gray-900">{startItem}-{endItem}</span> {t('filters.of')}{' '}
        <span className="font-semibold text-gray-900">{totalItems}</span> {t('filters.results')}
      </div>
