    ...
    <QueryClientProvider client={queryClient}>
      <Router>
        <Routes>
          ...
          <Route path="/listing/:id" element={<VehicleDetailPage />} />
          <Route path="/map" element={<VehicleMapViewPage />} />
          ...
          <Route path="*" element={
            <div className="min-h-screen flex items-center justify-center">
              <div className="text-center">
                ...
                <a href="/" className="inline-block mt-4 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Volver al inicio</a>
              </div>
            </div>
          } />
        </Routes>
