...
// NAVEGACIÓN SIMPLIFICADA - MENOS ES MÁS
  
  // Links principales - SOLO LO ESENCIAL (máximo 2 para navbar limpio)
  const mainNavLinks = [
...
{/* Desktop Navigation - SIMPLIFICADO Y LIMPIO */}
          ...
          {/* Tablet Navigation - Solo icono burger */}
