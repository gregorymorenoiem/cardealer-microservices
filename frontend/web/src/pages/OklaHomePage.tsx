...
import { OklaTrustBadge } from '../components/atoms/okla/OklaBadge';
...
const benefits = [
  ...
  },
  {
    ...
    description: 'Haz que tu producto sea el primero que vean los compradores.',
  },
  {
    icon: MessageCircle,
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              {/* Headline */}
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 dark:text-white leading-tight mb-6">
                Descubre lo
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg md:text-xl text-gray-800 mb-8 max-w-2xl mx-auto">
                Publica tus productos y llega a compradores interesados en nuestra plataforma segura.
              </p>
