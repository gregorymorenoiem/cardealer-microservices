...
export default function HeroCarousel({ 
  ...
  return (
    <div className={`relative w-full h-[600px] overflow-hidden bg-gray-900 ${className}`}>
      {/* Slides */}
            ...
            <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col justify-center h-full max-w-2xl">
                ...
                <div className="flex flex-wrap gap-4 mb-8 text-white/90">
                  ...
                  <span className="text-lg">{vehicle.transmission}</span>
                  <span className="text-white/50">•</span>
                  <span className="text-lg">{vehicle.fuelType}</span>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold rounded-lg transition-colors duration-200 text-lg border border-white/20"
                  >
                    Contactar Vendedor
                  </button>
                </div>
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full transition-colors duration-200 border border-white/20"
      ...
      <button
        onClick={goToNext}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full transition-colors duration-200 border border-white/20"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="p-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full transition-colors duration-200 border border-white/20"
