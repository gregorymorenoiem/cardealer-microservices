...
class _SortBottomSheetState extends State<SortBottomSheet>
  ...
  final List<SortOption> _sortOptions = [
    SortOption(
      id: 'relevance',
      title: 'Relevancia',
      subtitle: 'Mejor coincidencia para tu búsqueda',
      icon: Icons.star_outline,
    ),
    SortOption(
      id: 'price_low',
      title: 'Precio: Menor a Mayor',
      subtitle: 'Los más económicos primero',
      icon: Icons.arrow_upward,
    ),
    SortOption(
      id: 'price_high',
      title: 'Precio: Mayor a Menor',
      subtitle: 'Vehículos premium primero',
    ...
    SortOption(
      id: 'year_old',
      title: 'Año: Más Antiguo',
      subtitle: 'Vehículos clásicos',
      icon: Icons.history,
    ),
    SortOption(
      id: 'mileage_low',
      title: 'Kilometraje: Menor Primero',
      subtitle: 'Menos recorridos',
      icon: Icons.speed,
    ),
    SortOption(
      id: 'mileage_high',
      title: 'Kilometraje: Mayor Primero',
      subtitle: 'Más recorridos',
      icon: Icons.trending_up,
    ),
    SortOption(
      id: 'date_new',
      title: 'Listados Más Recientes',
